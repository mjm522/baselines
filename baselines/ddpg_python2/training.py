...
from baselines.ddpg_python2.ddpg import DDPG
from baselines.ddpg_python2.util import mpi_mean, mpi_std, mpi_max, mpi_sum
import baselines.ddpg_python2.tf_util as U
        ...
        for epoch in range(nb_epochs):
            ...
            for cycle in range(nb_epoch_cycles):
                ...
                for t_train in range(nb_train_steps):
                    ...
                    if plot_losses:
                        plt.subplot(211)
                        plt.plot(epoch_critic_losses, 'r')
                        plt.subplot(212)
                        plt.plot(epoch_actor_losses, 'g')
                        plt.pause(0.000001)
                        plt.draw()
